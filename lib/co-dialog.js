...
codialog.prototype.foreachTipEvent = function (getEvt,follow) {
    ...
    getEvt.forEach(function (inx,a) {
        debugger
        $(follow).on(inx,function (ev) {
            ev.preventDefault();
            $(self.dialogElement).show();
        })
    })
}*/
...
codialog.prototype.dialogTip = function (self) {
    var _left = self.offsetLeft;
    var _top = self.offsetTop;
    var _width = self.offsetWidth;
    var _height = self.offsetHeight;
