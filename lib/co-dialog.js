    ...
    if (Object.prototype.toString.call(obj) == '[object Object]') {
        ...
        ** **/
        ...
        if (typeof obj.isGesture != 'undefined' && typeof obj.isGesture == 'boolean' ) {
            if (obj.isGesture) {
                $(this.dialogElement).find('[dialog]').css('cursor','all-scroll');
            }
        }
            ...
            if (obj.isDrag) {
                ...
                dialog.on('mousedown',function (ev) {
                    ...
                    $(this).on('mouseover',function (e) {
                        ...
                        vx = ofw_x_Half - originX;
                        vy = ofw_y_Half - originy;
                        $(this).css({'margin-left':x,'margin-top':y,left:0,top:0});
                    })
                });
