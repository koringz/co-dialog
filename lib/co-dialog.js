...
codialog.prototype.showTip = function (self,pos) {
    ...
    if(pos == 'left') {
        director = {
            LEFT: _left - _width/2 + box_width/2 + scroll_left,
    ...
    box.css({position:'absolute','background-color': 'transparent','border-radius':0,margin:0,left: director.LEFT,top: director.TOP});
}
