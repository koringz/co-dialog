...
// 发送验证码111弹窗
codialog.app('.newDialog-test-overflow')
.use({
    dialogWidth: 585,
    dialogHeight: 237.93,
    title: '发送验证码111',
...
lust.title = '开通成功';
lust.message = '协议已开通，赶快充值吧！协议已开通，赶快充值吧！协议已开通，赶快充值吧！协议已开通，赶快充值吧！协议已开通，赶快充值吧！协议已开通，赶快充值吧！协议已开通，赶快充值吧！';
...
.use(Object.assign(lust, {
    ...
    methods: function (nodes) {
        this.message = '协议已开通，赶快充值吧！协议已开通，赶快充值吧！协议已开通，赶快充值吧！协议已开通，赶快充值吧！协议已开通，赶快充值吧！协议已开通，赶快充值吧！协议已开通，赶快充值吧！';
        $(nodes).css({'text-align':'center','color':'#fc862e','font-size':14});
...
codialog.coani('.newDialog-test-overflow [dialog],.newDialog-test-overflow [mask]').delay(50).zoomInRight(function (){
    codialog.app('.newDialog-test-overflow').hide().show({timeout: 1000});
}).stop();

codialog.coani('.open-success [dialog],.open-success [mask]').delay(1500).zoomInRight(function (){
    codialog.app('.open-success').hide().show({timeout: 3000});
}).stop();
